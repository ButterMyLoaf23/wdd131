...
export function successTemplate(info) {
    return `<p>Thank you ${info.name} for registering. You have registered ${info.participants} participants and owe $${info.fee} in Fees.</p>`;
}
...
export function getParticipantCount() {
    return document.querySelectorAll(".participants section").length;
}
